    ...
    content = [
        {
            ...
            "text": (
                ...
                "Quando não houver defeito ou problema aparente na foto, não invente uma falha. "
                "Nesses casos, retorne o title como 'Sem defeito aparente na foto', severity 'Media', "
                "custo baixo de inspeção preventiva, e use actions/scope/checks para listar os principais "
                "pontos que a foto talvez possa sugerir ou que merecem monitoramento preventivo. "
